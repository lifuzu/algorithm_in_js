...
//var p1 = {x: 6, y: 2}, p2 = {x: 1, y: 4}, p3 = {x: 7, y: 6};
var p1 = {x: 2, y: 5.4}, p2 = {x: 6, y: 3.5}, p3 = {x: 6.7, y: 4.3};
...
p1 = {x: (a.x+b.x+c.x+d.x+e.x)/5, y: (a.y+b.y+c.y+d.y+e.y)/5}
p2 = {x: (f.x+h.x+k.x+l.x)/4, y: (f.y +h.y + k.y + l.y)/4}
p3 = {x: (g.x+i.x+j.x)/3, y:(g.y+i.y+j.y)/3}
console.log(p1)
console.log(p2)
console.log(p3)
